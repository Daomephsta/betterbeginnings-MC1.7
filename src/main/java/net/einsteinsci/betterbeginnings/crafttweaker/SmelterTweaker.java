...
public class SmelterTweaker
{
    ...
    @ZenMethod
    public static void addRecipe(IItemStack output, IIngredient input, float xp, int boosters, int bonusPerBooster, float chance)
    {
	MineTweakerAPI.apply(new AddSmelterRecipe(output, input, xp, boosters, bonusPerBooster, chance));
    }

    @ZenMethod
    public static void addRecipe(IItemStack output, IIngredient input, float xp)
    {
	addRecipe(output, input, xp, 1, 1, 0.25F);
    }
	...
	public AddSmelterRecipe(IItemStack output, IIngredient input, float xp, int boosters, int bonusPerBooster, float chance)
	{
	...
	public void apply()
	{
	    recipe = SmelterRecipeHandler.addRecipe(input, output, xp, boosters, bonus, chance);
	}
